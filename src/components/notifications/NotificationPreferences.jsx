...
const SCHEDULED_EVENTS = [
  ...
  {
    key: 'condicionante_vencendo',
    label: 'Condicionante de Licenca Vencendo',
    icon: '📋',
    availableDays: [30, 15, 7, 3, 1],
    defaultDays: [15, 7, 1],
    hint: 'Condicionantes tem prazo proprio, separado do vencimento da licenca.',
    whatsappRecommended: true,
  },
  {
