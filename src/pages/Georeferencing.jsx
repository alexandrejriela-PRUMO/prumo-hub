...
export default function Georeferencing() {
  ...
  const { data: allPropertiesForClient = [] } = useQuery({
    queryKey: ['all-properties-for-client-geo'],
  ...
  // Para consultor usa consultorPropertyId, para produtor/client usa selectedProperty
  ...
  useEffect(() => {
    if (effectiveProperties.length > 0 && !selectedProperty && !isConsultor) {
      setSelectedProperty(effectiveProperties[0].id);
    }
  }, [effectiveProperties, selectedProperty, isConsultor]);
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {/* Property Selector */}
      {!isClientConsultor && effectiveProperties.length > 1 && (
        <Card>
      ...
      {/* Georeferencing List */}
      {(isConsultor && !consultorPropertyId) || (isClientConsultor && !selectedProperty) ? (
